...
if "agent_specs" not in data:
    data["agent_specs"] = AGENT_SPECS
    os.makedirs(STATE_FILE.parent, exist_ok=True)
    with open(STATE_FILE, "w") as f:
        json.dump(data, f, indent=4)
        print("Updated simulator_state.json with agent_specs")
else:
    print("agent_specs already exists in simulator_state.json")
